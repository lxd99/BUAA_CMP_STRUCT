...
LAB50:    t46 = *((unsigned int *)t12);
    *((unsigned int *)t12) = (t46 & 4294967295U);
    t47 = *((unsigned int *)t38);
    *((unsigned int *)t38) = (t47 & 4294967295U);
    t48 = (t0 + 2728);
    xsi_vlogvar_wait_assign_value(t48, t12, 0, 0, 32, 0LL);
    goto LAB35;
...
LAB77:    if (*((unsigned int *)t38) > 0)
        goto LAB78;

LAB79:    if (*((unsigned int *)t19) > 0)
        goto LAB80;

LAB81:    memcpy(t12, t48, 8);

LAB82:    t51 = (t0 + 2728);
    xsi_vlogvar_wait_assign_value(t51, t12, 0, 0, 32, 0LL);
    goto LAB35;
...
LAB78:    xsi_vlog_unsigned_bit_combine(t12, 32, t43, 32, t48, 32);
    goto LAB82;

LAB80:    memcpy(t12, t43, 8);
    goto LAB82;
...
extern void work_m_00000000002733713619_2725559894_init()
{
	...
	xsi_register_didat("work_m_00000000002733713619_2725559894", "isim/test_isim_beh.exe.sim/work/m_00000000002733713619_2725559894.didat");
